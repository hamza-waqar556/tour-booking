...
<!-- These are the new Airlines -->
<div class="aiob-input-group">
    <div class="heading">Flight Airlines</div>
    <div class="airline-search-container">

        <input type="text" name="_flight_airlines" class="airline-search-input" placeholder="Search Airlines..." value="<?php echo esc_attr($to_airport) ?>" />

        <ul class="airline-search-results"></ul>
    </div>
</div>



<!--  To || These are new Dynamic Airports -->
<div class="aiob-input-group">
    ...
    <div class="airport-search-container">
        ...
        <div class="airport-search-input-wrapper">
            ...
            <input type="text" name="from_airport" class="airport-search-input" placeholder="Search Airports..." value="<?php echo esc_attr($from_airport); ?>" />
        </div>
...
<div class="aiob-input-group">
    ...
    <div class="airport-search-container">
        ...
        <div class="airport-search-input-wrapper">
            ...
            <!-- This box will be updated with the airport code -->
            <div class="airport-code-box-input"></div>
            <input type="text" name="to_airport" class="airport-search-input" placeholder="Search Airports..." value="<?php echo esc_attr($from_airport); ?>" />
        </div>
        <ul class="airport-search-results"></ul>
    </div>
</div>
