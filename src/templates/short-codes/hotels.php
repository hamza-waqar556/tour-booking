<div class="container">
            ...
            <form action="#" id="searchHotels">
                <div class="row row-gap-3 align-items-start">
                    <div class="col-md">
                        <select id="hotel-locate" class="form-select text-capitalize"
                    ...
                    <div class="col-md">
                        <input type="text" class="w-100 form-control" id="hotelCheckIn" placeholder="CheckIn">
                    </div>
                    <div class="col-md">
                        <input type="text" class="w-100 form-control" id="hotelCheckOut" placeholder="CheckOut">
                    </div>
                    <div class="col-md">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu p-3 w-100" aria-labelledby="travelerDropdown"
                                ...
                                <li>
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <div>
                                            <button class="btn btn-outline-secondary btn-sm decrease"
                                                data-type="rooms-decrease">-</button>
                                            <span class="mx-2 count" data-type="rooms">0</span>
                                            <button class="btn btn-outline-secondary btn-sm increase"
                                                data-type="rooms-increase">+</button>
                                        </div>
                                    </div>
                                </li>
                            </ul>
            ...
            <div class="hotels-output-wrapper mt-5 bg-white">
                <div class="row">
                    ...
                    <div class="col-12 col-md-9">
                        <div class="p-4">
                            ...
                            <div class="mb-5" id="hotels-card-wrapper">
                                <div class="hotels-card border p-3 rounded mb-3">
                                    <div class="row align-items-start row-gap-2">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <p class="m-0">
                                                Casablanca St - Garhoud - Dubai - United Arab Emirates Dubai United Arab
                                                Emirates
                                            </p>
                                        </div>
