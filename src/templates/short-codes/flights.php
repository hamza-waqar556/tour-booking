        <div class="container">
            ...
            <form action="#" id="searchFlights">
                        ...
                        <div class="d-flex items-center gap-3">
                            ...
                            <div class="">
                                <label for="multi-trip">
                                    <input type="radio" name="flights" id="multi-trip" value="multi-trip">
                                    <span>
                                      Multi Trip
                                    </span>
                                </label>
                ...
                <div class="row row-gap-3 align-items-center">
                    ...
                    <div class="col-md">
                        <div class="dropdown">
                            <button class="btn bg-white border w-100 text-start" type="button" id="travellerDropdown"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                Travellers: 0
                            </button>
                            <ul class="dropdown-menu p-3 w-100" aria-labelledby="travellerDropdown"
